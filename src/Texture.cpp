...
Texture::Texture(const std::string& path)
	:m_FilePath(path),m_Width(0), m_Height(0),m_LocalBuffer(nullptr),m_BPP(0),m_RendererID(0)
{
	// OpenGL hope we use bottom left to be the zero zero
	// we make it upside down
